...
Approach
Loaded all CSV datasets into PySpark DataFrames from FileStore
Performed data validation:
o Checked schema and data types
o Verified data consistency across tables
Joined multiple tables using appropriate keys (customer_id, order_id, product_id)
Applied transformations:
o groupBy and aggregations
o window functions (rank, running total)
o filtering and conditional logic
Created final analytical and reporting datasets
