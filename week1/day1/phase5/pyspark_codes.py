...
# Task 1: Top 3 Customers per City Calculate total spend per customer, then use window function 
# to rank customers within each city. Output: city, customer_id, total_spend, rank
